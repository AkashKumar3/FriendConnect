...
export default function UserCard({ 
  ...
  const sendFriendRequest = useMutation({
    mutationFn: async () => {
      await axios.post(`https://friendconnect-backend.onrender.com/api/friends/request/${user._id}`);
    },
    onSuccess: () => {
  ...
  const respondToRequest = useMutation({
    mutationFn: async ({ status }) => {
      await axios.post(`https://friendconnect-backend.onrender.com/api/friends/respond/${requestId}`, { status });
    },
    onSuccess: (_, { status }) => {
  ...
  const removeFriend = useMutation({
    mutationFn: async () => {
      await axios.delete(`https://friendconnect-backend.onrender.com/api/friends/${user._id}`);
    },
    onSuccess: () => {
